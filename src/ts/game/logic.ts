...
export class GameLogic {
     ...
     * @param param0.offset Optional, move the entity by the given offset first
     * @returns true if the entity could be placed there
     */
    checkCanPlaceEntity(
        entity: Entity,
        {
     ...
     * @param param0.tile The tile to check at
     * @param param0.edge The edge to check for
     */
     ...
     * @returns Null if the entity is never able to be connected at the given tile
     */
