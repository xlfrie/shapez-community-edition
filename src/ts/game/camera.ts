...
export class Camera extends BasicSerializableObject {
    ...
    //// Handlers
    public downPreHandler = new Signal<[Vector, enumMouseButton]>();
    public movePreHandler = new Signal<[Vector]>();
    //// this.pinchPreHandler =  (new Signal());
    public upPostHandler = new Signal<[Vector]>();

    public eventListenerTouchStart: (event: TouchEvent) => boolean;
    public eventListenerTouchEnd: (event?: TouchEvent) => boolean;
    public eventListenerTouchMove: (event: TouchEvent) => boolean;
    public eventListenerMousewheel: (event: WheelEvent) => boolean;
    public eventListenerMouseDown: (event: MouseEvent) => boolean;
    public eventListenerMouseMove: (event: MouseEvent) => boolean;
    public eventListenerMouseUp: (event?: MouseEvent) => boolean;
     ...
     * @returns true if the user interacts
     */
