...
export class WireSystem extends GameSystem {
    ...
    public networks: Array<WireNetwork> = [];
     ...
     * @param variantMask Only accept connections to this mask
     */
    findSurroundingWireTargets(
        initialTile: Vector,
        directions: Array<enumDirection>,
        network: WireNetwork,
        variantMask: enumWireVariant = null
    ): Array<any> {
        let result = [];
