...
export class UndergroundBeltComponent extends Component {
    ...
    /** @param param0.mode As which type of belt the entity acts */
     ...
     * @param beltSpeed How fast this item travels
     */
     ...
     * @param travelDistance How many tiles this item has to travel
     * @param beltSpeed How fast this item travels
     * @param now Current ingame time
     */
