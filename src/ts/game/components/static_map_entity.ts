...
export class StaticMapEntityComponent extends Component {
     ...
     * @param param0.tileSize Size of the entity in tiles
     * @param param0.rotation Rotation in degrees. Must be multiple of 90
     * @param param0.originalRotation Original Rotation in degrees. Must be multiple of 90
     * @param param0.code Building code
     */
     ...
     * @param extrudePixels How many pixels to extrude the sprite
     * @param overridePosition Whether to drwa the entity at a different location
     */
    drawSpriteOnBoundsClipped(
        parameters: DrawParameters,
        sprite: AtlasSprite,
        extrudePixels: number = 0,
        overridePosition: Vector = null
    ) {
