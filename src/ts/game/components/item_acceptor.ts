...
export class ItemAcceptorComponent extends Component {
    ...
    /** @param param0.slots The slots from which we accept items */
     ...
     * @param remainingProgress World space remaining progress, can be set to set the start position of the item
     */
    onItemAccepted(
        slotIndex: number,
        direction: enumDirection,
        item: BaseItem,
        remainingProgress: number = 0.0
    ) {
