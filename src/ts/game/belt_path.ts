...
export class BeltPath extends BasicSerializableObject {
     ...
     */
    public items: Array<[number, BaseItem]> = [];

    public totalLength: number;
    public spacingToFirstItem: number;
     ...
     * @param computeSpacing Whether to also compute the spacing
     */
     ...
     * @param debug_Silent Whether debug output should be silent
     * @return
     */
    ...
    draw(parameters: DrawParameters) {
        ...
        let drawStack: Array<[Vector, BaseItem]> = [];
        let drawStackProp = "";
    ...
    drawDrawStack(stack: Array<[Vector, BaseItem]>, parameters: DrawParameters, directionProp) {
        if (stack.length === 0) {
            return;
        }
