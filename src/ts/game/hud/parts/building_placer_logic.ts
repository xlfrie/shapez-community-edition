...
export class HUDBuildingPlacerLogic extends BaseHUDPart {
    ...
    public currentBaseRotationGeneral: number;
    public preferredBaseRotations: {};
    public currentlyDragging: boolean;
    public currentVariant: TrackedState;
    public currentlyDeleting: boolean;
    public preferredVariants: {};
    public lastDragTile: Vector;
    ...
    checkForDirectionLockSwitch({ keyCode }: any) {
        if (
            keyCode ===
    ...
    tryPlaceCurrentBuildingAt(tile: Vector) {
        if (this.root.camera.getIsMapOverlayActive()) {
    ...
    onSelectedMetaBuildingChanged(metaBuilding: MetaBuilding) {
        this.abortDragging();
